<template>
  ...
  >
    <el-row v-bind="getRow" :gutter="20" style="width: 100%;">
      <slot name="formHeader"></slot>
      <el-col  style="width: 100%" :span="resultCol" v-for="schema in getSchema" :key="schema.field">
        <FormItem
...
<script lang="ts" setup>
  ...
  import {labelWidthMap, responsiveMap} from "@/components/Form/src/constant";
